defmodule SmmMonitor.SSH.HostKey do
  ...
  @doc """
  Default host key directory: `/var/lib/smm-monitor/ssh` under systemd,
  `~/.local/share/smm_monitor/ssh` otherwise.

  State, not configuration — it is generated by the app rather than
  written by an operator, and it must survive a deploy.
  """
  @spec default_dir() :: Path.t()
  def default_dir, do: SmmMonitor.Paths.state("ssh")
